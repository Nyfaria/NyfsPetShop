...
public class VillagerInit {
    ...
    public static RegistryObject<VillagerProfession> PET_ITEMS = VILLAGER_PROFESSIONS.register("pet_items", () -> new VillagerProfession(Constants.MODID + ":pet_items",
    ...
    public static RegistryObject<VillagerProfession> PETS = VILLAGER_PROFESSIONS.register("pets", () -> new VillagerProfession(Constants.MODID + ":pets",
