...
public class DataSerializerInit {
    ...
    public static final RegistryObject<EntityDataSerializer<MovementType>> MOVEMENT_TYPE = ENTITY_DATA_SERIALIZERS.register("geo_type",()->createEnumDataSerializer(MovementType.class));
