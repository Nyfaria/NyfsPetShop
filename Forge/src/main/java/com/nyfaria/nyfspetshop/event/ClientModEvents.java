...
public class ClientModEvents {
    ...
    public static void onEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(EntityInit.BROWN_TUXEDO_MUNCHKIN.get(), context -> new PetRenderer<>(context, new DefaultedEntityGeoModel<BaseCat>(new ResourceLocation(Constants.MODID, "munchkin"), true).withAltTexture(new ResourceLocation(Constants.MODID, "brown_tuxedo_munchkin"))));
